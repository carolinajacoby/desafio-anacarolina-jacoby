...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ...
        test.each([
            ['chantily e cafe', 'dinheiro', 'R$ 4,27', ['cafe,1', 'chantily,1']],
            ['queijo e sanduiche', 'credito', 'R$ 8,76', ['sanduiche,1', 'queijo,1']],
            ['queijo e sanduiche', 'credito', 'Item extra não pode ser pedido sem o principal', ['combo1,1', 'queijo,1']],
            ['queijo com outro item e cafe', 'credito', 'R$ 18,23', ['suco,1', 'queijo,1', 'cafe,1', 'sanduiche,1']],
            ['queijo e cafe', 'debito', 'Item extra não pode ser pedido sem o principal', ['cafe,1', 'queijo,1']],
            ['queijo com outro item e cafe', 'credito', 'R$ 11,85', ['cafe,1', 'queijo,1', 'sanduiche,1']],
            ['chantily com outro item e sanduiche', 'dinheiro', 'R$ 12,35', ['sanduiche,1', 'queijo,1', 'chantily,1', 'cafe,1' ]],
            ['chantily com outro item e sanduiche', 'credito', 'Item extra não pode ser pedido sem o principal', ['sanduiche,1', 'chantily,1', 'queijo,1']],
        ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
            validaTeste(formaDePagamento, resultadoEsperado, itens));
